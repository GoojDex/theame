window['main_js'] = function () {
    ...
    function DEV_unesc_entities(text) {
        return text
            .replaceAll('#039', "'")
            .replaceAll('&quot;', '"')
            .replaceAll('&gt;', '>')
    ...
    function _0x5e4196() {
        ...
        if (typeof (window['DEV_LICENSE']) == 'undefined') {
            return false;
        }
        /* get code if input is a full template XML code */
        var code = window['DEV_LICENSE'];
    ...
    */
    ...
    $('#devchandelpro-labels').each(function () {
    ...
    */
    ...
    http://devchandelprodemo.blogspot.com/search?action=getTitles&widgetId=BlogArchive1&widgetType=BlogArchive&responseType=js&path=http%3A%2F%2Fdevchandelprodemo.blogspot.com%2F2015_05_01_archive.html*/
    function b_valid_json(json) {
        // bad json
        if (typeof (json) == 'undefined' || typeof (DEV_LICENSE) == 'undefined') {
            return false;
        }
    ...
    */
    ...
    function show_blogger_comment() {
        ...
        if (typeof (DEV_LICENSE) == 'undefined') {
            return false;
        }
    ...
    */
    ...
    $('.post-body-inner').each(function () {
        var html = $(this).html();
        var tag_selector_start = 'devchandelpro-lock-start';
        var tag_selector_end = 'devchandelpro-lock-end';
    ...
    $('.post-body-inner').each(function () {
        ...
        var html = $(this).html();
        var key = '<span class="devchandelpro-next-page"></span>';
        ...
        if ($('.post-pagination').length) {
            unwrap_tag('.post-body-inner .devchandelpro-next-page', '.post-body-inner', key);
    ...
    */
    ...
    function get_the_author(entry, avatar, link) {
        ...
        if ('' == link && 'Dev Chandel' == entry.author.name) {
            link = 'https://www.devchandel.tk';
        }
    ...
    if (STICKY_SIDEBAR && ($('#main-sidebar').css('float') != 'none') && typeof (IE) == 'undefined') {
        ...
        /* sticky sidebar */
        var DEV_prev_win_top = 0;
        var init_sidebar_left = 0;

        function DEV_sticky_sidebar_disable() {
            $('#sidebar')
                .removeClass('fix-top fix-bot abs-stay abs-bot')
                .removeAttr('style');
        }

        function DEV_sticky_sidebar_start() {
            DEV_sticky_sidebar();
            $(window).scroll(function () {
                DEV_sticky_sidebar();
            });
            $(window).resize(function () {
                DEV_sticky_sidebar_disable();
            });
        }

        function DEV_sticky_sidebar() {
